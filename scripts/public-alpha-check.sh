...
check_public_surface() {
  local paths=(
    ...
    "docs/assets/screenshots/channel-registration.png"
    "docs/assets/screenshots/existing-archive-import.png"
    ...
    "docs/assets/user-manual/en/01-home.png"
    "docs/assets/user-manual/en/03-channel-registration.png"
    "docs/assets/user-manual/en/04-backup-schedule.png"
    "docs/assets/user-manual/en/10-settings.png"
    "docs/assets/user-manual/en/11-mobile-dashboard.png"
    "docs/assets/user-manual/ko/01-home.png"
    "docs/assets/user-manual/ko/03-channel-registration.png"
    "docs/assets/user-manual/ko/04-backup-schedule.png"
    "docs/assets/user-manual/ko/10-settings.png"
...
run_step "release script syntax" bash -lc "bash -n scripts/public-alpha-check.sh && bash -n scripts/compose-smoke.sh && bash -n scripts/deployment-smoke.sh && bash -n scripts/capture-public-demo.sh && bash -n scripts/capture-user-manual-screenshots.sh"
