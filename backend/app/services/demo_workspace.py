...
async def seed_demo_workspace(*, db: AsyncSession, download_dir: str) -> DemoWorkspaceResult:
    ...
    videos = [
        Video(
            ...
            description="Preserved local copy after the source removed the upload.",
            ...
            last_seen_in_source_at=now - timedelta(days=9),
            removed_detected_at=now - timedelta(days=2),
            tags=["demo", "archive"],
